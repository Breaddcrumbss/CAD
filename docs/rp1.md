...
**Vaka submerged percentage:** {{ site.data.rp1_beaching_buoyancy.vaka.submerged_percent }} liters  
...
**Ama submerged percentage:** {{ site.data.rp1_beaching_buoyancy.ama.submerged_percent }} liters  
